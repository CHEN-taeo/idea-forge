  ...
  return (
    <input
      ...
      className={cn(
        ...
        "shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_2px_rgba(0,0,0,0.15)]",
        "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] focus-visible:shadow-[0_1px_3px_rgba(0,0,0,0.3),0_2px_10px_rgba(251,191,36,0.12)]",
